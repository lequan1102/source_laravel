		...
		<div class="container">
			<div class="row">
				<div class="col-sm-6 col-lg-3 p-b-50">
					...
					<ul>
						@foreach ($category_footer as $item)
						<li class="p-b-10">
							<a href="{{ route('category.index', ['slug' => $item->slug,'id' => $item->id]) }}" class="stext-107 cl7 hov-cl1 trans-04">
								{{ $item->name }}
							</a>
						</li>
						@endforeach
			...
			<div class="p-t-40">
				...
				<p class="stext-107 cl6 txt-center">Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | Made with <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="" target="_blank">Colorlib</a> &amp; distributed by <a href="" target="_blank">ThemeWagon</a></p>
			</div>
		</div>
	</footer>
