                    ...
                    <ul class="list-treeview">
                        ...
                        <li class="treeview @if ( $segment == 'settings') color_sidebar @endif">
                            ...
                            <ul class="treeview-menu  @if ( $segment == 'settings') menu-open @endif" id="Settings">
                                <li><a href="{{ route('index.menu') }}">Thực đơn</a>
                                <li><a href="/settings">Quyền</a></li>
                                <li><a href="/sidebar">Sidebar</a></li>
                                <li><a href="{{ route('index.settings') }}">Cấu hình</a></li>
                            </ul>
                            <!--Treeview Mobie-->
                            <ul class="treeview-mobie">
                                <li><a href="{{ route('index.menu') }}">Thực đơn</a></li>
                                <li><a href="/settings">Quyền</a></li>
                                <li><a href="/sidebar">Sidebar</a></li>
                                <li><a href="/settings">Cấu hình</a></li>
                            </ul>
                        </li>
                    </ul>
                </nav>
