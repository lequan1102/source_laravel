                    ...
                    <div class="col col-lg-8 col-12">
                        <div class="panel">
                            ...
                            <div class="panel-body">
                                <input type="text" id="tieude" name="name" class="form-control" placeholder="Tên sản phẩm">
                        ...
                        <div class="panel">
                            ...
                            <div class="panel-body">
                                <textarea id="editor" name="body" cols="30" rows="10" style="visibility: hidden; display: none;"></textarea>
                            </div>
                        </div>
                        <div class="panel">
                            <div class="panel-title">
                            ...
                            <div class="panel-body">
                                <textarea id="excerpt" name="excerpt" class="form-control" rows="2"></textarea>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="panel">
                            ...
                            <div class="panel-body body_seo" style="display: none;">
                                <div class="form-group">
                                    ...
                                    <textarea id="keywordmeta" name="meta_description" class="form-control" rows="2"></textarea>
                                </div>
                                <div class="form-group">
                                    <label for="keywordmeta">Từ khóa Meta</label>
                                    <textarea id="keywordmeta" name="meta_keywords" class="form-control" rows="2"></textarea>
                                </div>
                                <div class="form-group">
                                    <label for="seotitle">Tiêu đề SEO</label>
                                    <input type="text" id="seotitle" name="seo_title" class="form-control" placeholder="Tiêu đề SEO">
                                </div>
                            </div>
                        </div>
