                  ...
                  <div class="panel">
                      <div class="panel-body" style="padding: 15px">
                        ...
                        <div class="form-group" style="margin-bottom: 0px">
                          ...
                          <input type="text" placeholder="Tên Vai trò" name="display_name" class="form-control">
                        </div>
                        @foreach ($permissions as $permission)
                          <div class="form-check">
                            <input type="checkbox" name="permission[]" class="form-check-input" id="exampleCheck{{ $permission->id }}" value="{{ $permission->id }}">
