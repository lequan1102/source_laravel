                    ...
                    <div class="col col-12">
                        <div class="panel">
                            ...
                            <div class="panel-body">
                                ...
                                <input type="text" id="tieude" name="name" class="form-control" placeholder="Tiêu đề" value="{{ $edit->name }}">
                                ...
                                <div class="panel">
                                    ...
                                    <div class="panel-body">
                                        <div class="form-group">
                                            ...
                                            <input id="meta_description" type="text" value="{{ old('meta_description') }}" name="meta_description" class="form-control">
                                        </div>
                                        <div class="form-group">
                                            <label for="keyword_meta">Từ khóa Meta</label>
                                            <input id="keyword_meta" type="text" value="{{ old('meta_keywords') }}" name="meta_keywords" class="form-control">
                                        </div>
                                        <div class="form-group">
                                            <label for="seo_name">Tiêu đề SEO</label>
                                            <input id="seo_name" type="text" value="{{ old('seo_name') }}" name="seo_name" class="form-control">
                                        </div>
                                    </div>
                                </div>
                            </div>
