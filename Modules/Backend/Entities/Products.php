...
class Products extends Model
{
    ...
    protected $fillable = ['name', 'slug', 'body', 'category_id', 'author_id', 'thumbnail', 'excerpt', 'status', 'meta_description', 'meta_keywords', 'seo_title'];

    public function author(){
        return $this->hasOne('Modules\Backend\Entities\Admin','id','author_id');
    }
    public function category(){
        return $this->belongsTo('Modules\Backend\Entities\Category','category_id');
    }
}
